# Senior + Principal + Distinguished Engineer Mindset — Skill Bundle

A skill collection that makes an AI think like a senior, principal, *and* distinguished/fellow-level engineer before writing code — three stacked lenses (this task, cross-team, company/industry-wide), most tasks only needing the first. Instead of one giant skill, it's split into **small, composable disciplines**.
