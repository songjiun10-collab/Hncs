...
**해석 (2026-09-06 정정 반영)**: 재보정의 +42.87%와 v2의 +8.80% 사이
34%p를 전부 노출 보정이라고 볼 수 없다. 보정된 auto-bright 결과는
+25.03%p를 설명하고 +17.84%p가 남는다. 따라서 +8.80%는 v2 후보의 검증
결과이지만, 재보정 이득을 노출과 룩으로 완전히 분해하려면 추가 통제 실험이
필요하다.
