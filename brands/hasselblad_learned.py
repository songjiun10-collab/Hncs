...
둘 사이 어딘가에서 이기는 지점은 없었다. 최적(=v11) vs v12(lambda=0
- `_build_lut_from_counts`가 평균·prior-backfill로 근사한 v12
구성이며, learn_curve 자체의 중앙값/np.interp LUT과 동일하지는
않음) 유의성 검정: 평균 오차 31.716(v12) vs 16.989(v11), 개선폭
46.4%, 폴드 승패 60승 14패, 부호검정 p=0.000, 부트스트랩 95% CI
[+35.5%, +56.4%](0 미포함, 아래 74쌍 learn_curve 재검증의 19.94 vs
22.20보다도 더 크게 벌어짐 - 이 스크립트의 percentile 기반 LOO
오차와 learn_curve의 측정 방식이 달라 절대값은 직접 비교 대상이
아니지만 방향과 유의성은 일치).
