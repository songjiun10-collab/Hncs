...
돌렸다(`tools/fit/evaluate_new_body_de00_grid.py` - 저해상도(200px) 폴드별
콤보 선택, 400px 확정, 이어서 `tools/fit/evaluate_native_pixel_confirm.py`로
...
`python3 -m tools.fit.evaluate_new_body_de00_grid --label "Sigma BF"
...
2D 그리드서치(`tools/fit/evaluate_all_brands_clahe_shoulder_grid.py`)를
...
(`tools/fit/evaluate_clahe_clip_native_confirm.py`, n=51) - **+9.54%, 40승11패,
...
# (tools/fit/evaluate_all_brands_clahe_shoulder_grid.py, n=82, +7.04%,
