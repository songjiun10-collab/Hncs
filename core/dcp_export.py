...
**비공식 피드백(2026-09-01, 미확인)**: 색감이 색온도 기준 약 1000K
정도 나아졌다는 사용자 전언 - 정확히 무엇 대비(libraw 기본 렌더링?
이전 깨진 DCP? 카메라 자체 JPEG?)인지, 어느 방향(더 따뜻하게/차갑게)
인지, 어떻게 측정했는지(육안? 스포이드?) 확정되지 않아 이 문서의 다른
"실측"과 같은 신뢰도로 기록하지 않는다 - 정성적 사용자 인상으로만
남긴다."""
import struct
