...
until `python3 -m tools.data.verify_contributed_pairs <dir> [--make Leica]`
...
signature in the JPEG's EXIF Software tag. `tools/data/build_local_manifest.py`
...
`tools/cli/analyze.py`; committed numbers must reproduce from the cached
