...
`brands/*_learned.py` are measurement output from `tools/fit/fit_final_lut.py`
...
def _deny_or_override(target, reason, tool_use_id=None):
    ...
    deny(
        ...
        "actually reproduce this value from tools/fit/fit_final_lut.py or an "
...
def main():
    ...
    if tool == "Write":
        ...
        _deny_or_override(
            ...
            "tools/fit/fit_final_lut.py - a Write overwrites the whole file, "
            "which may include hand-editing that array instead of "
            "regenerating it. Confirm this isn't a hand-edit of the LUT "
            "values, or regenerate via tools/fit/fit_final_lut.py instead.",
    ...
    for e in edits:
        ...
        if name:
            _deny_or_override(
                ...
                "generated by tools/fit/fit_final_lut.py (raw+jpeg fitting + "
                ...
                "re-run tools/fit/fit_final_lut.py instead.",
                tool_use_id=tool_use_id,
            )
            return
