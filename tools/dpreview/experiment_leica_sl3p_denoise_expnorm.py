...
5-fold CV ΔE00 floor(~12.73, `tools/dpreview/fit_leica_sl3p_studio_chart.py`)를
줄이는지 테스트. 업스케일링(`tools/dpreview/experiment_leica_sl3p_upscale_chart.py`)은
...
매트릭스를 피팅해서 이 타협 오차가 줄어드는지 확인한다.
  ...
  python3 -m tools.dpreview.experiment_leica_sl3p_denoise_expnorm <DNG 폴더 경로>
"""
import glob
import math
import os
