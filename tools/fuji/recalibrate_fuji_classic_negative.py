...
**왜**: `tools/fuji/evaluate_fuji_pairing_fix_impact.py`(2026-09-04)가 이 룩의
...
교체는 별도 커밋에서 사람이 확인하고 한다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.fuji.recalibrate_fuji_classic_negative
"""
import csv
import json
import math
...
VERIFY_MAX_DIM = 400  # 최종 확인용, tools/fuji/evaluate_fuji_preset_de00.py와 같은 값
N_FOLDS = 5
SEED = 0
