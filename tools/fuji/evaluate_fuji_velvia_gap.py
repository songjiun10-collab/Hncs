...
**배경**: `tools/fuji/evaluate_fuji_film_mode_separation.py`(2026-09-04)가
...
**방법**: `tools/fuji/evaluate_fuji_preset_de00.py`와 같은 경로 -
...
**배포 아님**: `brands/fuji.py`를 수정하지 않는다. 측정만 한다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.fuji.evaluate_fuji_velvia_gap
"""
import csv
import json
import math
...
def main():
    ...
    report = {
        ...
        "context": "tools/fuji/evaluate_fuji_film_mode_separation.py가 같은 장면 묶음에서 "
