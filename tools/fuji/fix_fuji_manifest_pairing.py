"""`tools/fuji/verify_fuji_manifest_pairing.py`가 확정한 후지 `local-work-2026-08`
...
버그 정정판")에서 못 잡은 잔여분으로 보인다.
  ...
  python3 -m tools.fuji.fix_fuji_manifest_pairing
"""
import csv
import os
import sys
...
def main():
    ...
    print("검증: python3 -m tools.fuji.verify_fuji_manifest_pairing")
