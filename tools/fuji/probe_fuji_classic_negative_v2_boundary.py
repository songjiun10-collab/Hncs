...
**왜 필요한가**: `tools/fuji/evaluate_fuji_classic_negative_v2_grid.py`가 사전에
...
(`tools/research/diagnose_neutral_render_offset_by_brand.py`, HSV S -19.490,
...
`brands/fuji.py`는 읽기만 한다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.fuji.probe_fuji_classic_negative_v2_boundary
"""
import csv
import json
import os
...
from tools.fuji.evaluate_fuji_classic_negative_v2_grid import apply_candidate
...
# tools/fuji/evaluate_fuji_classic_negative_v2_grid.py 전체표본 최적값
