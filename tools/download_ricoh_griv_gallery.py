"""tools/dpreview_ricoh_griv_links.csv(Ricoh GR IV, dpreview 샘플 갤러리
...
(다른 브랜드에서 이미 검증된 패턴, tools/download_xcd_lens_gallery.py 참고).

  python3 -m tools.download_ricoh_griv_gallery
"""
import csv
import os
import subprocess
