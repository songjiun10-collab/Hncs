...
`tools/demo/build_hybrid_engine_demo.py`와 같은 RAW 파이프라인 렌더링을
여러 장에 대해 반복해서 세로로 이어붙인 다중 before/after 그리드를
만든다.

  python3 -m tools.demo.build_hybrid_engine_demo_more \\
...
from tools.demo.build_hybrid_engine_demo import (
    BAR_H,
    BG,
    FG,
