...
`tools/fit_leica_sl3p_studio_chart.py`(2026-09-02, Leica SL3-P 최초 적용)를
...
def fit_and_issue(raw_dir, brand, camera_display_name, ext, illuminant=23):
    ...
    report = {
        ...
        "_comment": (
            ...
            "발급용 in-sample 피팅. 실기기 UniqueCameraModel 미확인 - "
            f"'{camera_display_name}'는 EXIF Model 문자열."
        ),
    }
    ...
    write_dcp(out_dcp, camera_model=camera_display_name, profile_name=f"HNCS {camera_display_name} Chart Colorimetric",
...
def main():
    ...
    fit_and_issue(args.raw_dir, args.brand, args.camera_display_name, args.ext, args.illuminant)
