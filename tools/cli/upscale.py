"""Real-ESRGAN AI 업스케일 CLI. core/upscale.py 참고.
  ...
  python3 -m tools.cli.upscale input.jpg output.jpg --scale 4 --engine onnx
  python3 -m tools.cli.upscale input.jpg output.jpg --scale 2 --engine pytorch
  python3 -m tools.cli.upscale input.jpg output.jpg --scale 4 --tile-size 256 --tile-pad 16
"""
import argparse
import os
import sys
