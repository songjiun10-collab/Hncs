...
보존).
  ...
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space F-Log2
  python3 -m tools.cli.raw_pipeline input.CR3 output.exr --log-space S-Log3
  python3 -m tools.cli.raw_pipeline input.ARW output.tiff --log-space S-Log3 --lut looks/my_look.cube
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space S-Log3 --exposure 1.5
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space V-Log --auto-expose-mode highlight_safe
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space V-Log --auto-expose-mode matrix
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space S-Log3 --auto-wb-mode white_patch
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --log-space S-Log3 --auto-wb-mode shades_of_gray
  python3 -m tools.cli.raw_pipeline input.CR3 output.tiff --hdr-space HLG
  python3 -m tools.cli.raw_pipeline input.CR3 output.exr --hdr-space PQ --hdr-peak-nits 4000
  python3 -m tools.cli.raw_pipeline input.RAF output.tiff --log-space F-Log2 --lens-correct
...
from tools.cli.lens_correction import resolve_lens_params
