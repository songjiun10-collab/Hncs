...
노이즈 제거 CLI.
  ...
  python3 -m tools.cli.denoise input.jpg output.jpg
  python3 -m tools.cli.denoise input.jpg output.jpg --strength 15
  python3 -m tools.cli.denoise input.jpg output.jpg --method bilateral
"""
import argparse
import os
import sys
