...
**왜 만들었나**: `tools/research/diagnose_neutral_render_offset_by_brand.py`를 돌리다
...
이상이 있으면 종료코드 1. `--json <경로>`로 리포트를 저장한다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.research.audit_raw_decodability
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.research.audit_raw_decodability --json /tmp/raw_audit.json
"""
import argparse
import collections
import glob
