...
낮춘다(tools/research/evaluate_hncs_structural.py와 같은 근거: 전역 색 분포
...
# 측정이라 tools/research/evaluate_hncs_structural.py와 같은 근거로 축소가
...
def _sign_test_p(wins, losses):
    ...
    math.comb으로 직접 계산한다 - tools/research/evaluate_hncs_structural.py와
...
def summarize(results):
    ...
    t-통계량을 별도로 계산한다 - tools/research/evaluate_hncs_structural.py의
