...
별도 파일(brands/sony_a7v.py)에 새 함수로 추가한다.
  ...
  python3 -m tools.fit.evaluate_sony_a7v_grid_search
"""
import csv
import os
import sys
...
from tools.fit.calibrate import load_neutral_render, gray_stats, _resize_to_max_dim
...
def main():
    ...
    # 졌다(-1.02%, tools/fit/evaluate_sony_a7v_de00.py) - 목적함수(percentile)를
    ...
    from tools.fit.calibrate import summarize, print_summary
    s = summarize(paired)
