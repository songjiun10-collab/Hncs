...
(`tools/fit/fit_canon_deployable_pipeline.py`: 3x3 컬러매트릭스 최소자승 +
...
매트릭스+채도/색조만 새로 피팅해서 그 위에 얹는다.
  ...
  python3 -m tools.fit.fit_brand_matrix_chroma_pipeline <brand> [--loo]
  예: python3 -m tools.fit.fit_brand_matrix_chroma_pipeline sony --loo
"""
import csv
import math
