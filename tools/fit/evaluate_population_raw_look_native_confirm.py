"""
tools/fit/fit_population_body_de00_grid.py는 200px 콤보선택/400px LOO확정으로
...
파라미터(toe_lift/shoulder_start/white_point/clahe_clip) 직접 맞대결.
  ...
  python3 -m tools.fit.evaluate_population_raw_look_native_confirm <brand> <toe_lift> <shoulder_start> <white_point> <clahe_clip>
  예: python3 -m tools.fit.evaluate_population_raw_look_native_confirm sony 0.02 0.82 1.0 2.0
"""
import importlib
import math
...
from tools.fit.evaluate_expanded_clahe_shoulder_refit import collect_contributed_pairs
