"""
`tools/fit/fit_population_body_de00_grid.py sony ILCE-1M2`가 고른 후보
...
`tools/fit/evaluate_population_raw_look_native_confirm.py`와 같은 로더/
디코드 재사용, ILCE-1M2만 필터링.

  python3 -m tools.fit.evaluate_sony_a1ii_vs_raw_look
"""
import math
import os
import sys
...
from tools.fit.evaluate_expanded_clahe_shoulder_refit import (
