"""
tools/x2dii/evaluate_x2dii_clahe_shoulder_grid.py에서 확인한 것처럼, raw+jpeg로
...
확정된 값 그대로 고정 - 이번엔 shoulder_start x clahe_clip 2D만 훑는다.
  ...
  python3 -m tools.fit.evaluate_all_brands_clahe_shoulder_grid
"""
import csv
import math
import os
...
from brands.hasselblad.x1d50c import apply_hncs_x1d50c
...
GRID_MAX_DIM = 200
CONFIRM_MAX_DIM = 400  # tools/x2dii/evaluate_x2dii_clahe_shoulder_grid.py와 동일 - 3000px는 너무 느림
