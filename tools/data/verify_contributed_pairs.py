...
가리킨다).
  ...
  python3 -m tools.data.verify_contributed_pairs datasets/hasselblad/contributed/kmichels-x2dii-2026-07
  python3 -m tools.data.verify_contributed_pairs datasets/leica/contributed/<세트> --make Leica
