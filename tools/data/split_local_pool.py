...
매칭은 `tools.data.build_local_manifest`의 `find_pairs()`(전역 최적 1:1 배정)를
...
enemy jpeg를 선점)도 늘어난다.
  ...
  python3 -m tools.data.split_local_pool ~/local-work
...
from tools.data.build_local_manifest import append_manifest, drop_failed, find_pairs
