...
대신한다.
  ...
  python3 -m tools.data.build_flat_manifest "/Users/songjiun/local-work/raw pair" \
...
from tools.cli.analyze import _check_genuine_bytes
from tools.data.build_local_manifest import find_pairs, RAW_EXT as ALL_RAW_EXT
...
def main():
    ...
    import tools.data.build_local_manifest as blm
