...
`tools/x2dii/evaluate_dcp_irls_weighted.py`가 쓰는 것과 같은
...
갱신한 뒤 .dcp를 재발급한다.
  ...
  python3 -m tools.x2dii.refit_dcp_irls_cyan_init
"""
import glob
import json
import os
...
def main():
    ...
    report["_comment_irls_cyan_init"] = (
        ...
        "2.0으로 낮춰 재수렴시킨 결과 - tools/x2dii/evaluate_dcp_irls_weighted.py "
