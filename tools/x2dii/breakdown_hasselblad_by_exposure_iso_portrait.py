...
때(tools/fit/breakdown_by_exposure_iso.py)와 같은 진단이지만, Hasselblad는
...
묶어 오차가 어디 몰려있는지 본다. 새 튜닝 아님, in-sample 진단.
  ...
  python3 -m tools.x2dii.breakdown_hasselblad_by_exposure_iso_portrait
"""
import json
...
from tools.fit.calibrate import collect_local_pairs, load_neutral_render
