...
**왜 조명별인가 - 실패한 시도부터**: 먼저
`tools/x2dii/regenerate_x2dii_icc_v2_combined.py`로 범용 ICC를 combined 25장
...
배포 `.icc`/`.dcp`/`.json`은 건드리지 않는다 - 새 파일 2개만 추가한다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.x2dii.build_x2dii_capture_one_illuminant_icc
"""
import json
import os
import sys
...
def main():
    ...
    report = {
        ...
        "rejected_alternative": {
            ...
            "script": "tools/x2dii/regenerate_x2dii_icc_v2_combined.py",
