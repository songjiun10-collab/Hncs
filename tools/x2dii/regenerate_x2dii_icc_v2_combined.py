...
(v2). 기존 `tools/x2dii/regenerate_x2dii_icc.py`(v1)는 kmichels 단독 9장
매트릭스를 썼다.
...
배포 `.icc`를 덮어쓴다 - `.dcp`/`.json`은 건드리지 않는다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.x2dii.regenerate_x2dii_icc_v2_combined
"""
import json
import os
import sys
...
def main():
    ...
    report = {
        ...
        "supersedes": {
            ...
            "issued_by": "tools/x2dii/regenerate_x2dii_icc.py (v1, 2026-09-02)",
        },
