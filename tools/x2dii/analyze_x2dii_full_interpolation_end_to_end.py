...
(`tools/x2dii/refit_x2dii_dual_illuminant.py`, `tools/x2dii/validate_x2dii_dual_illuminant_real_algorithm.py`,
`tools/x2dii/analyze_x2dii_burst_fair_comparison.py` 전부 포함)이 공유하는
...
matrix_1/matrix_2로 순수 홀드아웃(리키지 없음, 기존과 동일).
  ...
  python3 -m tools.x2dii.analyze_x2dii_full_interpolation_end_to_end
"""
import glob
import json
import os
