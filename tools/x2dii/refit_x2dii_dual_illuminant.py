...
단일 조명이 아니라는 게 `tools/x2dii/analyze_x2dii_combined_lighting_split.py`
...
별개 문제(실기기 미검증으로 남긴다).
  ...
  python3 -m tools.x2dii.refit_x2dii_dual_illuminant
"""
import glob
import json
import os
...
def main():
    ...
    old_global_cv = 12.6865  # tools/x2dii/refit_x2dii_chart_combined.py 5-fold CV(재현값)
