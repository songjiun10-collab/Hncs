...
`tools/x2dii/evaluate_dcp_irls_weighted.py`가 9장 전체 LOO로 확인한 결과 기준
...
갱신한 뒤 .dcp를 재발급한다.
  ...
  python3 -m tools.x2dii.refit_dcp_irls_final
"""
import glob
import json
import os
...
def main():
    ...
    report["_comment_irls"] = (
        ...
        "least squares) - tools/x2dii/evaluate_dcp_irls_weighted.py 9장 LOO 기준 "
