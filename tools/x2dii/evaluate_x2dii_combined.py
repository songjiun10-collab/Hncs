...
tools/x2dii/evaluate_x2dii_reduce_de00.py에서 apply_hncs_x2dii 대비 단독으로
...
apply_hncs_x2dii()는 baseline 비교용으로만 쓰고 수정 안 함.
  ...
  python3 -m tools.x2dii.evaluate_x2dii_combined
"""
import csv
import itertools
import math
...
from tools.fit.calibrate import load_neutral_render, _resize_to_max_dim
