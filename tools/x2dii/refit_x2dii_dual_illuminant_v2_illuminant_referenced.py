"""`tools/x2dii/refit_x2dii_dual_illuminant.py`(v1)가 배포한 dual-illuminant
...
다시 fit한다. 검증은 `tools/x2dii/analyze_x2dii_illuminant_referenced_interpolation.py`와
...
자체는 안 바뀐다 - 바뀐 건 그 매트릭스를 fit할 때 쓰는 참조 XYZ뿐이다.
  ...
  python3 -m tools.x2dii.refit_x2dii_dual_illuminant_v2_illuminant_referenced
"""
import glob
import json
import os
