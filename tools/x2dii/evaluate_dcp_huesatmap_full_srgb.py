"""
`tools/x2dii/evaluate_dcp_huesatmap_srgb.py`(hue만 회전, S/V 불변)의 후속 -
...
**방법**: `tools/x2dii/evaluate_dcp_huesatmap_srgb.py`와 동일한 sRGB
...
는 Never-list다. 이 스크립트는 측정만 하고 어떤 프로필도 쓰지 않는다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.x2dii.evaluate_dcp_huesatmap_full_srgb
"""
import glob
import json
import math
