...
(`tools/x2dii/refit_dcp_irls_cyan_init.py`) 위에서 LOO ΔE00을 더 낮추는지
확인 - `tools/x2dii/dcp_export_huesatmap_experimental.py`(core/dcp_export.py
...
원점 기준 회전, L/채도는 불변) - 9장 leave-one-image-out.
  ...
  python3 -m tools.x2dii.evaluate_dcp_huesatmap
"""
import glob
import os
import sys
...
def main():
    ...
    # cyan 초기가중치 2.0 - tools/x2dii/refit_dcp_irls_cyan_init.py와 동일 시작점.
