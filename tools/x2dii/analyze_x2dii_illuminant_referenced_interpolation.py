"""실험4의 D50 편향 근본 수정판. `tools/x2dii/analyze_x2dii_full_interpolation_end_to_end.py`가
...
쪽으로 쏠림)과 대조적으로 완전히 회복됨.
  ...
  python3 -m tools.x2dii.analyze_x2dii_illuminant_referenced_interpolation
"""
import glob
import json
import os
