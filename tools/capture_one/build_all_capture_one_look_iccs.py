...
ICC로 굽는다. 지금까지는 `tools/capture_one/build_devicelink_icc_for_look.py`를 룩
...
않아 만든 경로다(`tools/capture_one/build_devicelink_icc_for_look.py` 독스트링 참고).
...
룩 DeviceLink ICC만 새로 쓴다.
  ...
  ~/.hncs-hybrid-venv312/bin/python3 -m tools.capture_one.build_all_capture_one_look_iccs
"""
import importlib
import json
import os
